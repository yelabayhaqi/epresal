...
<body>
    ...
    <div style="width: 100%; text-align: center; font-size: 14pt; padding: 15px 0px 15px 0px; "><b><u>LAPORAN REKAP JURNAL KEGIATAN</u></b></div>
    <table style="margin-bottom: 10px;">
        <tr>
            <td style="padding-left: 15px; width: 150px;">Nama</td>
            <td><span style="margin-left: 10px;"> : <b><?=session()->get('nama')?></b></span></td>
        </tr>
        <tr>
            <td style="padding-left: 15px; width: 150px;">NIP / NUPTK</td>
            <td><span style="margin-left: 10px;"> : <?=session()->get('nip')?></span></td>
        </tr>
        <tr>
