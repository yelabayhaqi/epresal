    ...
    <main id="main-content">
        <div class="container-fluid mx-0 my-0 px-2 mt-5">
            ...
            <div class="row mx-0 py-0 my-0">
                <div class="col py-4 mt-2 mx-2" style="box-shadow: 1px 1px 8px 2px rgba(0,0,0,0.2) !important; min-width: 300px;
                    background: rgb(12,193,241);
                    background: linear-gradient(28deg, rgba(12,193,241,1) 0%, rgba(4,209,222,1) 53%, rgba(0,194,233,1) 100%);
                    ">
                        <div class="row">
                            <div class="col fs-4 text-white fw-bold"><i class="fas fa-list-ol mr-3"></i>Presensi</div>
                            <div class="col">
                                <a href="<?=base_url()?>/bk/presensi" class="btn btn-light mx-2 px-3 py-2 my-0 fw-bold float-right"><i class="fas fa-eye mr-3"></i>Lihat</a>
                            </div>
                        </div>
                        <div class="row mx-0">
                            <table class="col mx-0 text-white">
                                <tr class="px-0 py-0" style="vertical-align: text-bottom;">
                                    <td class="py-0" style="min-width: 220px;">
                                        ...
                                        <span class="fw-bolder ml-2 badge fs-5" style="background-color: rgba(12,180,220,1); min-width: 30px;"><?=$jmlPres?></span>
                                    </td>
                                </tr>
                            </table>
                        </div>
                ...
                <div class="col py-4 mt-2 mx-2" style="box-shadow: 1px 1px 8px 2px rgba(0,0,0,0.2) !important; min-width: 300px;
                    ...
                    ">
                        <div class="row">
                            <div class="col fs-4 text-white fw-bold"><i class="fas fa-file-invoice mr-3"></i>Jurnal</div>
                            <div class="col">
                                <a href="<?=base_url()?>/bk/jurnal" class="btn btn-light mx-2 px-3 py-2 my-0 fw-bold float-right"><i class="fas fa-eye mr-3"></i>Lihat</a>
                            </div>
                        </div>
                        <div class="row mx-0">
                            <table class="col mx-0 text-white">
                                <tr class="px-0 py-0" style="vertical-align: text-bottom;">
                                    <td class="py-0" style="min-width: 220px;">
                                        ...
                                        <span class="fw-bolder ml-2 badge fs-5" style="background-color: rgba(15,150,50,0.8); min-width: 30px;"><?=$jmlJurnal?></span>
                                    </td>
                                </tr>
                            </table>
                        </div>
