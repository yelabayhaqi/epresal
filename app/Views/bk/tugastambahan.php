...
<?=$this->include('guru/templates/modalEditTugasTambahan')?>
    <div class="container-fluid mx-0 px-1 mt-4">
        <div class="back-hide"><a href="<?=base_url()?>/bk" type="button" class="btn btn-light px-3 mx-1 back-hide"><i class="fas fa-arrow-left mr-2 back-hide"></i>Kembali</a></div>
        ...
        <div class="row mx-0 my-3 py-0">
            <div class="col py-1 pb-3 mt-2 mx-2 mt-2" style="box-shadow: 1px 1px 8px 2px rgba(0,0,0,0.2) !important; min-width: 300px;
                ...
                <div class="row">
                    ...
                    <div class="col-auto" >
                        <button type="button" class="btn btn-light mx-0 mt-1 float-right" data-bs-toggle="modal" data-bs-target="#addTugasModal">
                            <i class="fas fa-plus mr-3r"></i>
                             Tambah Tugas
                        </button>
                    </div>
                </div>
            ...
            <div class="col pb-3 mt-2 mx-2 mt-2" style="box-shadow: 1px 1px 8px 2px rgba(0,0,0,0.2) !important; min-width: 300px;">
                <form action="<?= base_url()?>/bk/tugas/cetak" method="post">
                    <div class="row">
                        <div class="col fs-5 py-2 bg-secondary text-light fw-bold"><i class="fas fa-print text-light mr-2"></i>Cetak Rekap Jurnal Kegiatan</div>
                    </div>
        ...
        <div class="mx-2 my-2 px-0" style="box-shadow: 2px 1px 8px 1px rgba(0,0,0,0.2) !important;">
            <div class="text-light fw-bold py-2 bg-secondary">
                <i class="fas fa-list mr-3 ml-3"></i>Data Jurnal Kegiatan
            </div>
            <div class="px-2 py-2">
                    <div class="row mx-2">
      ...
      <div class="modal-body py-0">
        ...
        <?= csrf_field(); ?>
          ...
          <label for="inputTugas" class="col-form-label">Nama Tugas :</label>
            <select name="inputTugas" class="col custom-select mr-3" id="inputTugas" required>
                <option value="">-</option>
...
<script>
    $(document).ready(function() {
        document.getElementById("bk-jurnal").className="nav-link nav-link-activated";
        document.getElementById("bk-jurnal-icon").className="sb-nav-link-icon sb-nav-link-icon-activated";
