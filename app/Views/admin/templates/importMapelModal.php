<div class="modal fade mt-2" id="importMapelModal" tabindex="-1" aria-labelledby="importMapelModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="<?= base_url()?>/assets/img/sample-matapelajaran.png" class="img-fluid mx-auto">
        <ul class="alert alert-warning mt-2">
          <li class="ml-2">Sistem hanya akan membaca kolom tabel yang diblok biru (lihat gambar)</li>
          <li class="ml-2">kolom mapel Wajib diisi, kategori bersifat opsional / boleh dikosongi</li>
        ...
        <a href="<?= base_url()?>/assets/doc/datamapel.xlsx" target="_blank">(.xlsx)</a>
        <a href="<?= base_url()?>/assets/doc/datamapel.xls" target="_blank" class="ml-2">(.xls)</a>
        <form action="<?= base_url()?>/admin/datamapel/editmapel/importmapel" enctype="multipart/form-data" method="post">
