...
<script>
    $(document).ready(function() {
        document.getElementById("ad-keluh").className = "nav-link nav-link-activated";
        document.getElementById("ad-keluh-icon").className = "sb-nav-link-icon sb-nav-link-icon-activated";
        $('#pilihkelas').val("<?=$kelaspilih?>");
        $('#pilihkelas').on('change', function() {
            var kelas = this.value;
            window.location.href = "<?= base_url() ?>/admin/keluhan/" + kelas;
        });
    });
</script>
