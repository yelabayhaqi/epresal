...
<body>
    ...
    <table style="margin-bottom: 10px;">
        <tr>
            ...
            <td><span style="margin-left: 100px;"> : <b><?=session()->get('nama')?></b></td>
        </tr>
        <tr>
            <td style="padding-left: 15px;" >NIP / NUPTK</td>
            <td><span style="margin-left: 100px;"><?=":  " . session()->get('nip')?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><span style="margin-left: 100px;">: <b><?=($b1 == $b2)?$b1:$b1. " - " . $b2?></b></td>
        </tr>
    </table>
