...
<script>
    $(document).ready(function() {
        document.getElementById("gu-keluh").className = "nav-link nav-link-activated";
        document.getElementById("gu-keluh-icon").className = "sb-nav-link-icon sb-nav-link-icon-activated";
    });
</script>
